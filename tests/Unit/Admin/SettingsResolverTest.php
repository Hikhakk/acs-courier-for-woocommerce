...
final class SettingsResolverTest extends TestCase
{
    public function test_stored_values_are_used_when_no_constants_are_defined(): void
    {
        $c = SettingsResolver::resolve(
            ['company_id' => 'CO', 'company_password' => 'cpw', 'user_id' => 'U', 'user_password' => 'upw', 'api_key' => 'k'],
            []
        );
    ...
    {
        $c = SettingsResolver::resolve(
            ['company_id' => 'STORED', 'company_password' => 'cpw', 'user_id' => 'U', 'user_password' => 'upw', 'api_key' => 'stored-key'],
            ['ACS_WC_COMPANY_ID' => 'FROM_CONFIG', 'ACS_WC_API_KEY' => 'config-key']
        );
    ...
    {
        self::assertFalse(SettingsResolver::resolve([], [])->isComplete());
    }

    public function test_an_empty_constant_does_not_shadow_a_stored_value(): void
    {
        $c = SettingsResolver::resolve(
            ['company_id' => 'STORED', 'company_password' => 'c', 'user_id' => 'u', 'user_password' => 'p', 'api_key' => 'k'],
            ['ACS_WC_COMPANY_ID' => '']
        );
